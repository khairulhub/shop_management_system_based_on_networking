...
* Connect L3 switch fa0/2 with L2 switch gig0/1
* Connect L2 switch fa0/1-24 with patch panel
* Connect patch panel connector with cat6 cable
...
* Enter the router/switch system and configure it.
